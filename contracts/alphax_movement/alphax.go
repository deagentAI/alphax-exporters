...
func NewMoveAlphaX(moveAddr, rpcUrl, moduleName string, backupUrl []string) (*MoveAlphaX, error) {
...
func (m *MoveAlphaX) GetSignalPredictionEvent(ctx context.Context, start, limit int64) ([]*PredictionEvent, error) {
...
func (m *MoveAlphaX) getSignalPredictionEvent(ctx context.Context, rpcUrl string, start, limit int64) ([]*PredictionEvent, error) {
...
func (m *MoveAlphaX) GetCheckInEvent(ctx context.Context, start, limit int64) ([]*CheckInEvent, error) {
...
func (m *MoveAlphaX) getCheckInEvent(ctx context.Context, rpcUrl string, start, limit int64) ([]*CheckInEvent, error) {
	req, resp := protocol.AcquireRequest(), protocol.AcquireResponse()
	defer func() {
		protocol.ReleaseRequest(req)
		protocol.ReleaseResponse(resp)
...
func (m *MoveAlphaX) CheckInResult(ctx context.Context, addr string, currentDay int64) (bool, error) {
...
func (m *MoveAlphaX) checkInResult(ctx context.Context, rpcUrl string, addr string, currentDay int64) (bool, error) {
	req, resp := protocol.AcquireRequest(), protocol.AcquireResponse()
	defer func() {
		protocol.ReleaseRequest(req)
		protocol.ReleaseResponse(resp)
	...
	// {"function":"0x21737c31a43334567c18a56a4061579b36cc07f5a3a3bb95d8572aa210e64de2::alphaxv3::check_in_result",
	// "type_arguments":[],
...
func (m *MoveAlphaX) SignalPredictionResult(ctx context.Context, addr string, signalId uint32) (bool, uint32, uint8, error) {
...
func (m *MoveAlphaX) signalPredictionResult(ctx context.Context, rpcUrl string, addr string, signalId uint32) (bool, uint32, uint8, error) {
	req, resp := protocol.AcquireRequest(), protocol.AcquireResponse()
	defer func() {
		protocol.ReleaseRequest(req)
		protocol.ReleaseResponse(resp)
	...
	// {"function":"0x21737c31a43334567c18a56a4061579b36cc07f5a3a3bb95d8572aa210e64de2::alphaxv3::signal_predict_result",
	// "type_arguments":[],
