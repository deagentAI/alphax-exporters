...
func TestMoveAlphaX(t *testing.T) {
	m, _ := NewMoveAlphaX("0x21737c31a43334567c18a56a4061579b36cc07f5a3a3bb95d8572aa210e64de2",
		"https://aptos.testnet.porto.movementlabs.xyz/v1",
		"alphaxv4", []string{"https://testnet.porto.movementnetwork.xyz/v1"},
	)
