...
func NewAlphaxMEvm(rpcUrl string) (*AlphaxMEvm, error) {
...
func (m *AlphaxMEvm) GetSignalPredictionEvent(ctx context.Context, lastIndex, length int64) ([]*PredictionEvent, error) {
...
func (m *AlphaxMEvm) GetCheckInEvent(ctx context.Context, lastIndex, length int64) ([]*CheckInEvent, error) {
	req, resp := protocol.AcquireRequest(), protocol.AcquireResponse()
	defer func() {
		protocol.ReleaseRequest(req)
		protocol.ReleaseResponse(resp)
...
func (m *AlphaxMEvm) CheckInResult(ctx context.Context, addr string, currentDay int64) (bool, error) {
	req, resp := protocol.AcquireRequest(), protocol.AcquireResponse()
	defer func() {
		protocol.ReleaseRequest(req)
		protocol.ReleaseResponse(resp)
...
func (m *AlphaxMEvm) SignalPredictionResult(ctx context.Context, addr string, signalId uint32) (bool, uint32, uint8, error) {
	req, resp := protocol.AcquireRequest(), protocol.AcquireResponse()
	defer func() {
		protocol.ReleaseRequest(req)
		protocol.ReleaseResponse(resp)
...
func (m *AlphaxMEvm) GetTransactionReceiptStatus(ctx context.Context, txHashStr string) (int, error) {
	req, resp := protocol.AcquireRequest(), protocol.AcquireResponse()
	defer func() {
		protocol.ReleaseRequest(req)
		protocol.ReleaseResponse(resp)
